...
function Dashboard() {
  ...
  <div className="sticky top-0 z-10 w-6/7 mx-auto bg-[#030712] rounded-lg ml-3 mr-3" style={{ border: '2px solid #155e75' }}>
    <AdminHeader />
  </div>
  ...
  <div className="flex h-screen bg-gray-900">
    <div className="md:flex-shrink-0 w-14 md:w-64 bg-[#030712] text-white ml-3 rounded-lg h-83" style={{ border: '2px solid #155e75' }}>
